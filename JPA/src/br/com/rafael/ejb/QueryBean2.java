...
import br.com.rafael.model.Aula;
import br.com.rafael.model.Aula_;
import br.com.rafael.model.Curso;
import br.com.rafael.model.Curso_;
import br.com.rafael.model.Modulo;
import br.com.rafael.model.Modulo_;

@Singleton
@Startup
public class QueryBean2 {
	...
	public List<Aula> executar1() {
		...
		Root<Aula> root = cq.from(Aula.class);
		cq.select(root);
		cq.orderBy(cb.asc(root.get(Aula_.nome)));
		TypedQuery<Aula> query = this.em.createQuery(cq);
